...
| `Ponikowska_2026_DermatolTher_cardiovascular-disease-and-psoriasis.pdf` | Ponikowska M, Hill L, Lee CS, et al. *Dermatol Ther (Heidelb)* 2026;16:155–169. DOI 10.1007/s13555-025-01566-0 | **Establishes the CV context** cited in the abstract Background: ~50% increased major-CV-event risk; psoriasis endothelium shows 2–8× pro-inflammatory transcript upregulation; inflammasome is the top differentially expressed systemic pathway. Most genes it names are significantly up in our k=4 meta-analysis (S100A7A/A8/A9, CXCL10, PYCARD, CASP1, GSDMD); VCAM1 and NLRP3 are the exceptions, both n.s. |
