...
# Produces: gsea_meta_k4_primary.csv
# Conda env: psoriasis-r   (run with this environment activated)
# Inputs (expected alongside / in data/): paths.json
# Source artifact version: 940b3249-ba6d-4f47-b396-cd2d2ca5a528
# NOTE: absolute artifact paths rewritten to basenames; place named inputs in the same dir.
#------------------------------------------------------------

suppressMessages({library(fgsea); library(msigdbr); library(data.table)})
library(jsonlite)
