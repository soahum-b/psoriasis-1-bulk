...
# Produces: 01_target_list.pdf
# Conda env: dock-md   (run with this environment activated)
# Inputs (expected alongside / in data/): master_refs.json, fig_paths.json, 01_target_list.md
# Source artifact version: 3a1bfb6c-42ac-404a-85e2-9c008740878d
...
name, html, miss = render_paper("01_target_list.md")
full = f"<html><head><meta charset='utf-8'><style>{CSS}</style></head><body>{html}</body></html>"
weasyprint.HTML(string=full, base_url=".").write_pdf("01_target_list.pdf")
