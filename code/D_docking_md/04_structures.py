...
# Produces: 04_structures.pdf
# Conda env: dock-md   (run with this environment activated)
# Inputs (expected alongside / in data/): STAT3_6NJS.pdb, RORC_5APH.pdb, JAK3_5LWM.pdb, style.css, master_refs.json, 04_structures.md
# Source artifact version: 19ef2e43-cb4e-498e-b813-7e6b283f428d
...
# fig_paths: no figure for 04_structures
fig_paths = {}
...
mdpath = "04_structures.md"
name, html_body = render_paper3(mdpath)
full = f"<html><head><meta charset='utf-8'><style>{CSS}</style></head><body>{html_body}</body></html>"
weasyprint.HTML(string=full, base_url=".").write_pdf("04_structures.pdf")