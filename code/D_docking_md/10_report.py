...
# Produces: 10_report.pdf
# Conda env: dock-md   (run with this environment activated)
# Inputs (expected alongside / in data/): CONSOLIDATED_REPORT.md, style.css, master_refs.json, 10_report.md
# Source artifact version: 09d5e86d-1849-436b-a498-6118c44f8bc0
...
weasyprint.HTML(string=full, base_url=".").write_pdf("10_report.pdf")