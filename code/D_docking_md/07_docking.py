...
# Produces: 07_docking.pdf
# Conda env: dock-md   (run with this environment activated)
# Inputs (expected alongside / in data/): style.css, fig_paths.json, master_refs.json, docking_ranked.csv, validation.json, RORC_5APH.pdb, CHEMBL3314024.pdb, 07_docking.md
# Source artifact version: 64bd7203-105b-46ca-a7bc-ab4bd4c6973c
...
name, html_body = render_paper3("07_docking.md")
full = f"<html><head><meta charset='utf-8'><style>{CSS}</style></head><body>{html_body}</body></html>"
weasyprint.HTML(string=full, base_url="work/whitepapers").write_pdf("07_docking.pdf")