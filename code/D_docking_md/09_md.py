...
# Inputs (expected alongside / in data/): style.css, master_refs.json, 09_md.md, equilibrated.pdb, system.xml, state.xml
# Source artifact version: 70ed2323-add6-47ae-b480-dc97a63cca2f
...
fig_paths = {}  # no figure for paper 09_md
...
name, html_body = render_paper3("09_md.md")
full = f"<html><head><meta charset='utf-8'><style>{CSS}</style></head><body>{html_body}</body></html>"
weasyprint.HTML(string=full, base_url=".").write_pdf("09_md.pdf")