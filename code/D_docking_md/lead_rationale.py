...
# Produces: lead_rationale.md
# Conda env: python   (run with this environment activated)
# Inputs (expected alongside / in data/): druggability_annotation.csv, target_universe.csv
# Source artifact version: 7620df88-317c-468e-89c3-67c6aeeefd17
# NOTE: absolute artifact paths rewritten to basenames; place named inputs in the same dir.
#------------------------------------------------------------

rationale = """# Lead target selection — rationale
...
"""
open("lead_rationale.md","w").write(rationale)