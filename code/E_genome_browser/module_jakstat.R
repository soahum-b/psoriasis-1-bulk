...
# Produces: module_jakstat.png
# Conda env: psoriasis-r   (run with this environment activated)
# Inputs (expected alongside / in data/): trend_SRP165679.rds
# Source artifact version: 9ee03089-5208-431b-bd7a-f22f15c4bd05
...
tr <- readRDS("trend_SRP165679.rds")
setDT(tr)
...
n <- module_fig(c("STAT3","STAT1","JAK1","JAK3","TYK2","SOCS3"), "JAK-STAT", "module_jakstat.png")
cat("JAK-STAT rows:", n, "\n")