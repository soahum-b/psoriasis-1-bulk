...
# Produces: tf_activity_collectri.csv
# Conda env: psoriasis-r   (run with this environment activated)
# Inputs (expected alongside / in data/): de_results_full.rds
# Source artifact version: 8c0dc731-904a-454b-93dd-60de08a1b463
...
# Build CollecTRI regulon from OmniPath
raw <- fread("https://omnipathdb.org/interactions?resources=CollecTRI&datasets=collectri&fields=sources,references&genesymbols=1&organisms=9606", sep="\t", header=TRUE)
...
fwrite(tf_res, "tf_activity_collectri.csv")