...
# Source artifact version: 36751199-258e-4ecc-8db5-f7cc96fdecbe
...
saveRDS(list(real_frac=real_frac, real_gap=real_gap, null_frac=null_frac,
             null_dir=null_dir, n_perm=n_perm), "scissor_repo/results/permutation_null.rds")
write.csv(data.frame(perm=1:n_perm, null_selected_frac=null_frac, null_tier_gap=null_dir),
          "permutation_null.csv", row.names=FALSE)
