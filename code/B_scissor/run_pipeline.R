...
# Produces: run_pipeline.R
# Conda env: scissor-r   (run with this environment activated)
# Inputs (expected alongside / in data/): bulk_anchor.rds, rse_SRP165679.rds, scissor_run.R, scissor_reliability.R, scissor_glmnet_solver.R, sample_manifest.csv
# Source artifact version: 96398960-33db-416e-a01e-67a81556ed3e
...
writeLines(lines, "run_pipeline.R")