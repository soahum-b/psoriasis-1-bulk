...
# Produces: deconv_validation.R
# Conda env: scissor-r   (run with this environment activated)
# Inputs (expected alongside / in data/): bulk_anchor.rds, rse_SRP165679.rds, reference_processed.rds
# Source artifact version: cc7610a8-2cb2-4e53-af82-2ac98c096931
...
'saveRDS(list(props=props, trend=trend, signature=S), "deconv_result.rds")',
'print(trend)'
)

writeLines(lines, "deconv_validation.R")