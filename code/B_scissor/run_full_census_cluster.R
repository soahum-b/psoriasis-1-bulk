...
# Produces: run_full_census_cluster.R
# Conda env: scissor-r   (run with this environment activated)
# Inputs (expected alongside / in data/): scissor_run.R, scissor_reliability.R, scissor_glmnet_solver.R, bulk_anchor.rds, reference_processed.rds
# Source artifact version: ea3c71e8-2cd6-478e-99f7-ff23df6ead5c
# NOTE: absolute artifact paths rewritten to basenames; place named inputs in the same dir.
#------------------------------------------------------------

content = open("scissor_run.R").read()
...
with open('run_full_census_cluster.R', 'w') as f:
    f.write(code)