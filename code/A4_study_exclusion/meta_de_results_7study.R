...
# Produces: meta_de_results_7study.rds
# Conda env: psoriasis-r
# Source artifact version: 7f820456-34c5-4154-92d8-46a45b1c648c
#------------------------------------------------------------
...
saveRDS(meta_new, "meta_de_results_7study.rds")