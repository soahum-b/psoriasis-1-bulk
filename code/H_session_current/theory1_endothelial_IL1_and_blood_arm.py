...
# Produces: theory1_endothelial_IL1_and_blood_arm.md
# Conda env: python   (run with this environment activated)
# Inputs (expected alongside / in data/): gradient_program_DE_BH.csv, fullcensus_vs_backbone.csv, blood_arm_feasibility_recount3.csv, recount3_all_human_projects.rds
# Source artifact version: 1a3e3584-415c-45bc-9188-7a1375294dce
# NOTE: absolute artifact paths rewritten to basenames; place named inputs in the same dir.
#------------------------------------------------------------

content = """# Theory 1: IL-1-responsive vascular endothelium and the psoriasis→atherosclerosis axis
...
with open("theory1_endothelial_IL1_and_blood_arm.md", "w") as f:
    f.write(content)

print("saved theory1_endothelial_IL1_and_blood_arm.md")