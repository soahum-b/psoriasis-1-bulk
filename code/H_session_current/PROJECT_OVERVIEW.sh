...
# Produces: PROJECT_OVERVIEW.md
# Conda env: bash   (run with this environment activated)
# Inputs (expected alongside / in data/): none
# Source artifact version: 4ac7d7f6-d4d3-47f3-b9fb-eb74a947da20
# NOTE: absolute artifact paths rewritten to basenames; place named inputs in the same dir.
#------------------------------------------------------------

content = """# psoriasis-multiomics
...
with open("PROJECT_OVERVIEW.md", "w") as fh:
    fh.write(content)