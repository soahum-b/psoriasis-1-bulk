...
# Produces: STAGING_MANIFEST.md
# Conda env: bash   (run with this environment activated)
# Inputs (expected alongside / in data/): WHITEPAPER.md, per_study_de.rds
# Source artifact version: e5459792-61d5-4d35-ac44-592af14369b7
# NOTE: absolute artifact paths rewritten to basenames; place named inputs in the same dir.
#------------------------------------------------------------

content = """# Staging Manifest
...
with open("STAGING_MANIFEST.md", "w") as f:
    f.write(content)