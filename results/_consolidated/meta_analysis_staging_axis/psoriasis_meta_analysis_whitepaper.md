# A Meta-Analysis of the Psoriasis Transcriptome: From recount3 Counts to STAT3 Isoforms

*Working white paper — living document. Written alongside the analysis so that every
methodological choice is explained in plain language and can be defended in a talk.*
...
STAT3 hypothesis that is narrower but far more defensible: STAT3 is a reproducible central hub of
the psoriasis transcriptional programme, while the isoform-level mechanism remains, at most, a
